                ...
                <div id='img-answer' style={{height: "400px", display: "none", flexDirection: "column", justifyContent: "space-between", marginBottom: "200px"}}>
                    ...
                    <div style={{display: "flex"}}>
                        <div className={styles.containerAnswerSpan}>
                            ...
                            {/* <div onClick={() => handleClick('wrong')} className={styles.optionClick}></div>
                            <img src={imgSpan[0].img_answer[0]} alt='img-span'/> */}
                        </div>
                        <div className={styles.containerAnswerSpan}>
                            ...
                            {/* <div onClick={() => handleClick('correct')} className={styles.optionClick}></div>
                            <img src={imgSpan[0].img_answer[1]} alt='img-span'/> */}
                        </div>                                             
                    </div>                    
                </div>
