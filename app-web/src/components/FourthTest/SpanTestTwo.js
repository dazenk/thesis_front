...
const SpanTestTwo = () => {
    ...
    useEffect(() => {
        if (JSON.stringify(correctList[contador]) === JSON.stringify(listaCorrecta)) {
            console.log('iguales');
            /* if (contador == 0) setProcessPoints({...processPoints, ['rimse']: 1, ['rimsr']: 2}) */
            ...
            /* console.log("Lista correcta: ", correctList[contador]);
            console.log("Lista seleccionada:", listaCorrecta); */            
            ...
            if (puntua) {
                console.log('iguales, diferente orden');
                setPoints(points + 1);
            }
        }        
