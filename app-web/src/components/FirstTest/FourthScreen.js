...
const FourthScreen = () => {
    ...
    useEffect(() => {
      if (value == 0) {
          ...
          setWrongTree8([]);
          setWrongTree9([]);
          navigate("/FifthScreen", { replace: true });
      }
    }, [value]);
            ...
            {[...Array(144)].map((e, i) => {
              return (
                <div onClick={() => onClick(i, i)} className={styles.gridContainer} key={i} id={i}>
                  {correctTree.includes(i) && <img className={styles.imgArbol} src={imagenes[4].img} alt={'arbol'}/>}
          ...
          <div className={styles.rightContainer}>
            <div className={styles.exampleTree}>
              <div className={styles.containerImageExample}>
                <img className={styles.imageExample} src={imagenes[4].img} alt={'arbol'}/>
              </div>
            </div>
